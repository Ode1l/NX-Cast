...
#define AIRPLAY_SERVER_MAX_CONTROL_CLIENTS 4U
#define AIRPLAY_SERVER_MAX_LOCAL_MEDIA_CLIENTS 4U
#define AIRPLAY_SERVER_MAX_CLIENTS \
    (AIRPLAY_SERVER_MAX_CONTROL_CLIENTS + AIRPLAY_SERVER_MAX_LOCAL_MEDIA_CLIENTS)
