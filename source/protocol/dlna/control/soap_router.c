...
static const SoapRouteEntry g_routes[] = {
    ...
    {"AVTransport", g_serviceTypeAvTransport, "GetDeviceCapabilities", "avtransport_get_device_capabilities", avtransport_get_device_capabilities},
    {"AVTransport", g_serviceTypeAvTransport, "GetTransportInfo", "avtransport_get_transport_info", avtransport_get_transport_info},
    {"AVTransport", g_serviceTypeAvTransport, "GetTransportSettings", "avtransport_get_transport_settings", avtransport_get_transport_settings},
    ...
    {"AVTransport", g_serviceTypeAvTransport, "Next", "avtransport_next", avtransport_next},
    ...
    {"RenderingControl", g_serviceTypeRenderingControl, "ListPresets", "renderingcontrol_list_presets", renderingcontrol_list_presets},
    {"RenderingControl", g_serviceTypeRenderingControl, "SelectPreset", "renderingcontrol_select_preset", renderingcontrol_select_preset},
